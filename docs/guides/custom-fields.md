---
title: docs/guides/custom-fields
group: docs
---
...
> **Note:** The `element` function is called on every render. Keep it a thin wrapper —
...
> **Tip:** You can preview how the Mantine theme looks without installing anything at the
