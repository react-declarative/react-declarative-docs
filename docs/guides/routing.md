...
> **Note:** Pass `element` as a factory function `() => <MyPage />`, not as a component
...
> **Warning:** If `guard` returns `false`, the route simply does not render — it does not
...
> **Tip:** The demo application in the library source (`demo/src/App.tsx`) uses
