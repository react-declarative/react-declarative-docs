---
title: docs/guides/form-validation
group: docs
---
...
> **Note:** The `isInvalid` function receives the **whole data object**, not just the field's own value. Destructure what you need from the first argument.
...
> **Note:** `getAvailableFields` is purely a reflection utility — it does not render anything. Use it at submit time to clean up data before sending it to your API.
