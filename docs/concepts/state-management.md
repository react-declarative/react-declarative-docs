...
### isIncorrect — non-blocking validation
...
### isVisible — show or hide a field
...
### isDisabled — prevent interaction
...
### isReadonly — display without edit
...
3. **First onChange fires** — `onChange` is called once with `initial: true` to reflect the merged initial state. This gives you the fully resolved starting data.
