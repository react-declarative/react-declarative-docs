...
> **Tip:** For high-frequency updates, debounce emissions on `reloadSubject` to avoid excessive re-renders. The `useQueuedAction` hook from react-declarative can help serialise incoming WebSocket messages before calling reload.
