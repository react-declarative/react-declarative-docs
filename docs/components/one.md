...
> **Note:** `isInvalid` should return a **string** with the error message when validation
...
> **Tip:** Use `OneTyped` in new projects — the stricter generics catch schema mismatches
