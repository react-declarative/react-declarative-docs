...
> **Note:** The key difference from [jsonforms](https://jsonforms.io/docs/#how-does-it-work): you do **not** need a separate JSON Schema for your data model. All validations live inside the UI schema, so your backend can return partial data (PATCH-style) and the form adapts automatically.
...
**[Playground](https://react-declarative-playground.github.io/)**
